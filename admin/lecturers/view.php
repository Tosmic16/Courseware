...
<div class="table-responsive" style="background-color: white">
  ...
  ?>
        ...
        <td>
          ...
          <a class="btn btn-primary" href="update.php?lec=<?php echo $row['id'] ?>&img=<?php echo $row['image'] ?>&email=<?php echo $row['email'] ?>">Update</a>          
...
if (isset($_POST['delete'])) {
  ...
  $qr="DELETE FROM lecturer WHERE id = '$lec' ";
